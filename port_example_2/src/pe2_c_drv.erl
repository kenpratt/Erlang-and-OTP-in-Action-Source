...
%% API
-export([start_link/0, echo_msg/1]).
...
%% @doc
%%
%%  Echo the data provided in the argument back to the gen_server
%%
%% @spec echo_msg/1
%% @end
%%--------------------------------------------------------------------
...
%% @end
%%--------------------------------------------------------------------
handle_cast({data, Data}, State = #state{driver=Driver}) ->
    port_command(Driver, list_to_binary(Data)),
    {noreply, State}.
...
%%%===================================================================
load_driver() ->
  SearchDir = code:priv_dir(port_example_2),
